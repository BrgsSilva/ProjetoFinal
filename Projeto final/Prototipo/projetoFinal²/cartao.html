					...
					<form method="post" action="efetuar_login" class="form-inline">
						<div class="col-md-4 col-sm-4">
							<div class="form-group">
								...
								<label for="num" class="sr-only">Número do cartão</label>
								<input type="num" name="num" class="form-control" id="num" placeholder="Digite o numero do cartão"><br>
								<br>

								<label for="nome" class="sr-only">Nome</label>
								<input type="nome" name="nome" class="form-control" id="nome" placeholder="Digite o nome que consta no cartão"><br>
								<br>

								<label for="data" class="sr-only">Data</label>
								<input type="data" name="data" class="form-control" id="data" placeholder="Digite a data de validade"><br>
								<br>

								<label for="cod" class="sr-only">Código de segurança</label>
								<input type="cod" name="cod" class="form-control" id="cod" placeholder="Digite o código de segurança"><br>
								<br>

							    <button type="submit" class="btn btn-default btn-block">Efetuar Pagamento</button>
						    </div>		
						</div>
					</form>
				</div>
